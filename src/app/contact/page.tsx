            ...
            <div className="lg:col-span-7 bg-white border border-[#E5E7EB] rounded-2xl p-6 sm:p-10 shadow-sm text-left">
              ...
              <form className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="Software Development" defaultChecked className="peer sr-only" />
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="UI/UX Design" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                        UI/UX Design
                      </span>
                    </label>
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="Mobile Application" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                        Mobile Application
                      </span>
                    </label>
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="Cloud Infrastructure" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="Database Management" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                        Database Management
                      </span>
                    </label>
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="Web Development" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                        Web Development
                      </span>
                    </label>
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="AI & Automation" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                        AI &amp; Automation
                      </span>
                    </label>
                    ...
                    <label className="cursor-pointer">
                      <input type="radio" name="service" value="Digital Growth" className="peer sr-only" />
                      <span className="block p-2.5 text-xs text-center rounded border transition-colors truncate peer-checked:bg-[#0052FF] peer-checked:text-white peer-checked:border-[#0052FF] peer-checked:font-bold bg-[#F9FAFB] text-[#374151] border-[#E5E7EB] font-medium hover:bg-gray-100 peer-checked:hover:bg-[#0052FF]">
                        Digital Growth
                      </span>
                    </label>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <input
                      ...
                      className="w-full px-3.5 py-3 bg-[#F9FAFB] border border-[#E5E7EB] text-sm text-[#111827] outline-none rounded focus:border-[#0052FF] transition-colors"
                    />
                    <input
                      type="email"
                      name="workEmail"
                  ...
                  <div>
                    <textarea
                      ...
                      className="w-full px-3.5 py-3 bg-[#F9FAFB] border border-[#E5E7EB] text-sm text-[#111827] outline-none rounded focus:border-[#0052FF] transition-colors resize-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full h-12 bg-[#0052FF] hover:bg-[#0042D0] text-white font-semibold text-sm uppercase tracking-wider rounded transition-colors shadow-sm"
                  >
