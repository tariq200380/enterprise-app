    ...
    <section className="bg-[#0B1120] text-white py-10 sm:py-12 border-b border-white/10 relative overflow-hidden text-left">
      ...
      <div className="max-w-[1240px] mx-auto px-6 sm:px-10 relative z-10">
        <div className="max-w-[680px] mx-auto mb-10 sm:mb-14 text-center">
          <div className="text-xs font-mono font-bold uppercase tracking-[2.5px] text-[#EA580C] mb-3">
            THE CREED CODE
          </div>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight leading-[1.15] mb-4">
            Our four pillars of uncompromising engineering
          </h2>
          <p className="text-white/70 text-[15.5px] leading-[1.7]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-7">
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/10 rounded-xl p-6 sm:p-7 flex flex-col justify-between hover:border-orange-500/50 hover:bg-white/[0.07] transition-all shadow-lg group">
            <div>
              <div className="flex items-center justify-between mb-5">
                <span className="font-mono text-2xl font-bold text-[#EA580C]">01</span>
                <span className="text-[11px] font-mono text-white/80 border border-white/15 bg-white/10 px-2.5 py-1 rounded-[4px]">
                  Pillar of excellence
                </span>
              </div>
              <h3 className="font-serif font-medium text-xl text-white mb-1.5">
                Architectural integrity over shortcuts
              </h3>
              <div className="text-[#EA580C] text-[13px] font-mono font-semibold mb-3.5">
                We build for decades, not for quick demos.
              </div>
              <p className="text-slate-300 text-sm leading-[1.65] mb-4">
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/10 rounded-xl p-6 sm:p-7 flex flex-col justify-between hover:border-orange-500/50 hover:bg-white/[0.07] transition-all shadow-lg group">
            <div>
              <div className="flex items-center justify-between mb-5">
                <span className="font-mono text-2xl font-bold text-[#EA580C]">02</span>
                <span className="text-[11px] font-mono text-white/80 border border-white/15 bg-white/10 px-2.5 py-1 rounded-[4px]">
                  Pillar of excellence
                </span>
              </div>
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/10 rounded-xl p-6 sm:p-7 flex flex-col justify-between hover:border-orange-500/50 hover:bg-white/[0.07] transition-all shadow-lg group">
            <div>
              <div className="flex items-center justify-between mb-5">
                <span className="font-mono text-2xl font-bold text-[#EA580C]">03</span>
                <span className="text-[11px] font-mono text-white/80 border border-white/15 bg-white/10 px-2.5 py-1 rounded-[4px]">
                  Pillar of excellence
                </span>
              </div>
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/10 rounded-xl p-6 sm:p-7 flex flex-col justify-between hover:border-orange-500/50 hover:bg-white/[0.07] transition-all shadow-lg group">
            <div>
              <div className="flex items-center justify-between mb-5">
                <span className="font-mono text-2xl font-bold text-[#EA580C]">04</span>
                <span className="text-[11px] font-mono text-white/80 border border-white/15 bg-white/10 px-2.5 py-1 rounded-[4px]">
                  Pillar of excellence
                </span>
              </div>
