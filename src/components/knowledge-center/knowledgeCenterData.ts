...
export const brandWires: BrandWireItem[] = [
  ...
  },
  {
    ...
    summary:
      "NVIDIA announces intent to acquire open-source AI community leader Hugging Face, accelerating collaborative AI development, open models, and enterprise infrastructure across millions of builders.",
    source: "NVIDIA Official Blog",
    link: "https://blogs.nvidia.com/blog/nvidia-to-acquire-hugging-face/",
    img: "/uploads/live_news/nvidia_huggingface_hero.png",
  },
  {
    id: "anthropic",
    name: "Anthropic",
  ...
  },
  {
    ...
    summary:
      "Sundar Pichai outlines Google's vision for the agentic Gemini era, introducing autonomous agents, multi-turn reasoning capabilities, and enterprise-wide developer ecosystems.",
    source: "Google The Keyword",
    link: "https://blog.google/innovation-and-ai/sundar-pichai-io-2026/",
    img: "/uploads/live_news/google_agentic_io2026_hero.jpg",
  },
  {
    id: "intel",
    name: "Intel",
...
export const INITIAL_STORIES: LiveNewsItem[] = [
  ...
  },
  {
    ...
    source: "NVIDIA Official Blog",
    title: "NVIDIA to Acquire Hugging Face",
    desc: "NVIDIA announces intent to acquire open-source AI community leader Hugging Face, accelerating collaborative AI development, open models, and enterprise infrastructure across millions of builders.",
    link: "https://blogs.nvidia.com/blog/nvidia-to-acquire-hugging-face/",
    img: "/uploads/live_news/nvidia_huggingface_hero.png",
  },
  {
  ...
  },
  {
    ...
    source: "Google The Keyword",
    title: "I/O 2026: Welcome to the agentic Gemini era",
    desc: "Sundar Pichai outlines Google's vision for the agentic Gemini era, introducing autonomous agents, multi-turn reasoning capabilities, and enterprise-wide developer ecosystems.",
    link: "https://blog.google/innovation-and-ai/sundar-pichai-io-2026/",
    img: "/uploads/live_news/google_agentic_io2026_hero.jpg",
  },
  {
