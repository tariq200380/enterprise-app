    ...
    <section id="solution-areas" className="relative w-full py-12 lg:py-16 bg-[#F7F6F5] border-b border-[#E2E8F0]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          {/* Card 1: Business Platforms */}
          <div className="bg-white border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Custom systems for managing workflows information users and everyday business operations.
            </p>
          </div>

          {/* Card 2: Customer Portals */}
          <div className="bg-white border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            <div className="flex items-center gap-3.5 mb-4">
              <div className="w-[38px] h-[38px] rounded-[10px] bg-[#EFF6FF] border border-[#DBEAFE] flex items-center justify-center shrink-0">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#0052FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Secure digital experiences that help customers access services information requests and account features.
            </p>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Connected workflows that reduce repetitive steps and improve the movement of information between systems.
            </p>
          </div>

          {/* Card 4: Data Solutions */}
          <div className="bg-white border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            <div className="flex items-center gap-3.5 mb-4">
              <div className="w-[38px] h-[38px] rounded-[10px] bg-[#EFF6FF] border border-[#DBEAFE] flex items-center justify-center shrink-0">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#0052FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Structured applications for storing organizing accessing and presenting authorized business data.
            </p>
          </div>

          {/* Card 5: Digital Commerce */}
          <div className="bg-white border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            <div className="flex items-center gap-3.5 mb-4">
              <div className="w-[38px] h-[38px] rounded-[10px] bg-[#EFF6FF] border border-[#DBEAFE] flex items-center justify-center shrink-0">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#0052FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Web and mobile experiences supporting products services payments orders and customer interactions.
            </p>
          </div>

          {/* Card 6: AI-Assisted Tools */}
          <div className="bg-white border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.02)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            <div className="flex items-center gap-3.5 mb-4">
              <div className="w-[38px] h-[38px] rounded-[10px] bg-[#EFF6FF] border border-[#DBEAFE] flex items-center justify-center shrink-0">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#0052FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Task-focused AI features developed with defined data sources validation controls and human oversight.
            </p>
          </div>
        </div>
