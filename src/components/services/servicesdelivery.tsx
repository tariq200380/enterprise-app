        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white border border-[#E2E8F0] border-t-[3.5px] border-t-[#0052FF] hover:border-t-[#FF6B00] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.03)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Project scope priorities responsibilities and delivery stages are documented before implementation.
            </p>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] border-t-[3.5px] border-t-[#0052FF] hover:border-t-[#FF6B00] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.03)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Regular updates and review points provide visibility into development decisions and project status.
            </p>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] border-t-[3.5px] border-t-[#0052FF] hover:border-t-[#FF6B00] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.03)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Important functionality integrations responsive behavior and agreed workflows are reviewed before release.
            </p>
          </div>
          ...
          <div className="bg-white border border-[#E2E8F0] border-t-[3.5px] border-t-[#0052FF] hover:border-t-[#FF6B00] hover:border-[#CBD5E1] rounded-[14px] p-7 h-full flex flex-col shadow-[0_2px_8px_rgba(15,23,42,0.03)] hover:-translate-y-1.5 hover:shadow-[0_12px_24px_-4px_rgba(15,23,42,0.08)] transition-all duration-300 ease-out cursor-default">
            ...
            <p className="text-[15px] text-[#5B6472] leading-relaxed m-0 font-normal">
              Maintenance improvements and technical support can be provided according to the agreed service arrangement.
            </p>
          </div>
        </div>
