        ...
        <div className="w-full lg:w-[52%] grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-7 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-200 h-full">
            <div>
              ...
              <h3 className="text-lg font-medium text-[#0F172A] mb-2 tracking-tight">Risk Free</h3>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-7 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-orange-200 transition-all duration-200 h-full">
            <div>
              ...
              <h3 className="text-lg font-medium text-[#0F172A] mb-2 tracking-tight">Cost</h3>
              <p className="text-sm text-[#5B6472] leading-relaxed font-normal">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-7 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-orange-200 transition-all duration-200 h-full">
            <div>
              ...
              <h3 className="text-lg font-medium text-[#0F172A] mb-2 tracking-tight">Flexibility</h3>
              <p className="text-sm text-[#5B6472] leading-relaxed font-normal">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-7 flex flex-col justify-between shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-200 h-full">
            <div>
              ...
              <h3 className="text-lg font-medium text-[#0F172A] mb-2 tracking-tight">Dedicated Delivery</h3>
              <p className="text-sm text-[#5B6472] leading-relaxed font-normal">
