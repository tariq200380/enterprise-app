...
export default function FounderHotlineSection() {
  ...
  const inputClass = "w-full h-11 px-3.5 bg-slate-50 border border-slate-200 text-sm rounded-lg outline-none focus:border-[#FF6B00] focus:bg-white transition-colors text-slate-900";
  ...
  return (
    <>
      ...
      {/* Founder Proposal Submission Modal */}
      {showModal && (
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5">
                  ...
                  <div>
                    ...
                    <input name="subject" type="text" placeholder="e.g. Authentication endpoint rate limit / Data access policy" className={inputClass} />
                  </div>
